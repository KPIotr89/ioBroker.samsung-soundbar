...
// Codec names as reported by getCodec. Only PCM is confirmed so far; the rest
// follow Samsung's naming and are here to give stable numbers. An unknown name
// is published as -1 and logged, so the list can be completed from real logs.
const CODECS = [
    'PCM',
    'DOLBY_DIGITAL',
    'DOLBY_DIGITAL_PLUS',
