...
const CODEC_FAMILIES = [
    ...
    'MP3', // 9
    'OTHER', // 10
    'DOLBY_MAT', // 11 - multichannel PCM in a Dolby MAT container (Apple TV)
];
...
const RULES = [
    ...
    [ /DTS/, 5 ],
    [ /TRUE[_ -]?HD/, 3 ],
    // Apple TV keeps a permanent Dolby MAT link when Atmos is enabled, so even
    // plain 5.1 arrives as "MAT_PCM" - that is multichannel PCM, not TrueHD.
    [ /(^|_)MAT(_|$)/, 11 ],
    [ /PLUS|\+|DDP|E[_ -]?AC3/, 2 ],
    [ /DOLBY|(^|_)DD(_|$)|AC3/, 1 ],
    [ /AAC/, 8 ],
